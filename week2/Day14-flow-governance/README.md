...
Course Published
Approval Sequence
Department Head reviews the course proposal.
Academic Coordinator verifies academic requirements.
...
Leave Confirmed
Approval Sequence
Head of Department reviews leave request.
HR validates leave balance and policies.
After Approval
Leave is recorded.
...
Scholarship Granted
Approval Sequence
Faculty Advisor verifies eligibility.
Scholarship Committee evaluates application.
Finance Department approves funding.
After Approval
...
Finance Manager verifies budget availability.
Principal provides final authorization.
After Approval
Budget is allocated.
